...
<rapid:override name="content">
    ...
    <form class="layui-form" id="changeform" method="post" action="<%=basePath%>teacher/changeTeaPass" style="margin:80px 400px; width:450px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="coursename" id="teaId" placeholder="请输入教师账号" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <script>
        $(function () {
            $("#success").click(function () {
                ...
                var content=name+"|"+num+"|"+ins+"|"+teaId;
                ...
                myform.method = "POST";
                myform.action = "<%=basePath%>root/insertCourseSuccess?page="+1;
                myform.submit();
