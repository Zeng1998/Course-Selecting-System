...
<rapid:override name="content">
    ...
    <script>
        function goPage(page){
            window.location.href="<%=basePath%>root/detailCourse?courseid=<%=courseid%>&page="+page;
        }
        function update_score(stuId) {
            var s=document.getElementById(stuId).value;
            window.location.href="<%=basePath%>root/updateScore?courseid=<%=courseid%>"+"&stuId="+stuId+"&score="+s+"&page=<%=now_page%>";
        }
        function delete_fun(stuId) {
            var r=confirm("确认删除吗？")
            if (r==true)
            {
                window.location.href="<%=basePath%>root/deleteStuCourse?courseid=<%=courseid%>&stuid="+stuId;
            }
            else
            {
                return;
        ...
        function search() {
            ...
            window.location.href="<%=basePath%>root/searchStu?stuid="+stuid+"&courseid="+<%=courseid%>;
        }
    </script>
</rapid:override>
