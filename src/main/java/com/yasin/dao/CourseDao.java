...
import com.yasin.model.Course;
import com.yasin.model.Course_choose;
import com.yasin.model.Course_limit;
import com.yasin.model.Institution;

import java.util.List;

public interface CourseDao {
    public List<Course> queryCourseById(int id);
    public List<Course> queryAllCourseByRoot();
