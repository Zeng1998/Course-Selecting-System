...
<rapid:override name="content">
    ...
    <script>
        function insert() {
            window.location.href="<%=basePath%>root/insertCourse";
        }
    </script>
    ...
    <script>
        function goPage(page){
            window.location.href="<%=basePath%>root/courseList?page="+page;
        }
        function edit(classId) {
            window.location.href="<%=basePath%>root/editCourse?courseid="+classId;
        }
        function delete_fun(classId) {
            var r=confirm("确认删除吗？")
            if (r==true)
            {
                window.location.href="<%=basePath%>root/deleteCourse?courseid="+classId;
            }
            else
            {
                return;
        ...
        function detail_fun(classId) {
            window.location.href="<%=basePath%>root/detailCourse?courseid="+classId+"&page="+1;
        }
    </script>
</rapid:override>
